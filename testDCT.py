...
def embed_image(img, watermark, alpha):
    ...
    cv2.imshow("Vi tri ma QR o kenh mau do",Idct)
    
    # Thực hiện biến đổi ngược DCT
    I12 = idct2(Idct) 
    
    # chuyển sang kiểu số thực để ảnh có thể hiển thị rõ ràng không giảm chất lượng
    Ih = I0.astype(np.float32)
...
if __name__ == "__main__":
    ...
    # Trích xuất QR code 
    extracted_img = extract_image(embedded_img, alpha) 
